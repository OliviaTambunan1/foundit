...
export default function EditReport({ report, auth, categories }: EditReportProps) {
    ...
    return (
        <Layout user={auth.user}>
            <div className="px-8 py-7 max-w-xl">
                <div className="mb-6">
                    <h1 className="text-xl font-semibold text-[#0F172A]">Edit Laporan</h1>
                    <p className="text-sm text-[#64748B] mt-0.5">Perbarui informasi laporan barangmu</p>
                </div>
